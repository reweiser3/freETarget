...
#if CLOCK_TEST
  {"\"NC\":",             &json_clock[N],                    0,                IS_INT16,  0,                0,                       0 },    // Values forced into timer for
  {"\"EC\":",             &json_clock[E],                    0,                IS_INT16,  0,                0,                       0 },    // diagnostics
  {"\"SC\":",             &json_clock[S],                    0,                IS_INT16,  0,                0,                       0 },    //
  {"\"WC\":",             &json_clock[W],                    0,                IS_INT16,  0,                0,                       0 },    //
#endif

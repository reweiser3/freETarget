...
int tcpip_get(char* buffer, int length);                          // Get data waiting in the TCPIP stream
int tcpip_put(char* buffer, int length);                          // Send Get to the TCPIP stream
...
#define TCPIP   false, false, false
